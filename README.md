...
![Bibliothèque GameHuB](assets/library.jpg)
...
GameHuB = **un serveur** (héberge la bibliothèque) + **des clients** (les PC qui s'y connectent).
...
➡️ **[Télécharger `GameHuB-Setup.exe`](https://github.com/BenoitBounar/GameHUB-releases/releases/latest)**
...
> ⚠️ L'image `ghcr.io/benoitbounar/gamehub` doit être **publique** pour être téléchargeable.
...
<div align="center">
<sub>GameHuB — votre bibliothèque de jeux auto-hébergée.</sub>
</div>
